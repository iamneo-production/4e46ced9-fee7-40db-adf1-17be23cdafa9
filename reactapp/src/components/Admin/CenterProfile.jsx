...
function Centerprofile(){
    ...
    {data.map(item => (
      ...
      <div className="mb-3 d-flex align-items-center">
			<input type="text" className="form-control" id="editId" name="editId" placeholder='Enter the ID' autoComplete='off'/>
			</div>      
			<div className="mb-3 d-flex align-items-center">
				...
				<div className="mb-3 d-flex align-items-center">
					<input type="text" className="form-control" id="editAddress"  name='editAddress' placeholder='Enter the address' autoComplete='off' />
				</div>
				<div className="mb-3 d-flex align-items-center">
