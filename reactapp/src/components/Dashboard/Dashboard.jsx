...
function Dashboard() {
  ...
  const handleSubmit = (event) => {
    ...
    // Submit the form data to the backend
    axios
    .post(`http://localhost:5034/api/Appointment/dashboard/${id}`, {
      ...values,
      ...
      <div className="dashboard-container">
        ...
        <div className="right-column  col-9 bookinform">
          <form className="dashBoardBody" onSubmit={handleSubmit}>
            <h2>Enter the Details</h2>
            <div className="mb-3">
              <input type="text" id="enterProductName" placeholder="Enter the name of the product" name="productName" className="form-control rounded-2" autoComplete="off"
                onChange={handleInput}/>
            </div>
            <div className="mb-3">
              <input type="text" id="enterModelNo" placeholder="Enter the model no of the product" name="productModelNo" className="form-control rounded-2" autoComplete="off"
              onChange={handleInput}/>
            </div>
            <div className="mb-3">
              <input type="date" id="enterDateOfPurchase" placeholder="Enter the date of purchase"  name="dateOfPurchase" className="form-control rounded-2"  autoComplete="off" 
              onChange={handleInput}/>
            </div>
            <div className="mb-3">
              <input type="text" id="enterContactNumber" placeholder="Enter the contact number" name="contactNumber" className="form-control rounded-2" autoComplete="off"
              onChange={handleInput}/>
            </div>
            <div className="mb-3">
              <textarea id="enterProblem" placeholder="Enter the problem description" name="problemDescription" className="form-control rounded-2" rows="2" onChange={handleInput}></textarea>
            </div>
            <div className="mb-3">
